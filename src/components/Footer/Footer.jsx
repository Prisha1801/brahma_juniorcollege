...
const quickLinks = [
    ...
    { label: "Examination Notice",  to: "/examination-notice" },
    { label: "Contact",             to: "/contact" },
];

const additionalLinks = [
    { label: "Campus Placements",           to: "/campus-placement" },
    { label: "Approvals",                   to: "/approvals" },
    { label: "ANTI - Ragging Committee",    to: "/anti-ragging" },
    { label: "Vishakha Committee",          to: "/vishakha-committee" },
    { label: "Emergency Contact Details",   to: "/anti-ragging" },
